...
bci_rest_mi = loadmat('../../../Database_PWelch_AvgTrials_MI_Baseline_RS1_19Subjects_EEG_Sess4.mat')
bci_rest = bci_rest_mi['Avg_RS1_EEG_DK']
...
if __name__ == '__main__':
    ...
    directory = '/bci_results/eeg/sess4/rs1_allsubs_f0/'
    filename = f'{directory}rs1_nostim_mse_db_fvec330_{subid}.p'
