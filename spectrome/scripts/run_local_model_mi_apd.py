...
#replace path to data accordingly
bci_rest_mi = loadmat('../../../Database_PWelch_AvgTrials_MI_Baseline_RS1_19Subjects_EEG_Sess3.mat')
bci_rest = bci_rest_mi['Avg_MI_EEG_DK']
ind_psd = bci_rest[subid,:,3:30]
ind_psd = ind_psd/np.linalg.norm(ind_psd)

fvec = np.squeeze(bci_rest_mi["Freqs"])[3:30]
...
#how many times the parameters hit the bounds 
...
if __name__ == '__main__':
    ...
    directory= '/bci_results/eeg/sess3/mi_allsubs_f/'
